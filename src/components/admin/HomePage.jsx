          ...
          <div className="w-full max-w-2xl bg-[#f8f3ea] border border-[#d9c8a8] p-8 shadow-2xl">
            ...
            <form onSubmit={submitHanlder} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={btnLoading}
                className={`h-14 w-full text-sm uppercase tracking-[4px] transition-all duration-300 cursor-pointer flex items-center justify-center gap-3
                  
                  ${
                    btnLoading
                      ? "bg-[#BEA163] text-black cursor-not-allowed"
                      : "bg-[#1d1d1d] text-white hover:bg-[#BEA163] hover:text-black"
                  }
                `}
              >
